                ...
                <Card on elevation={3} className={clsx(classes.detailsCard)}>
                  <CardContent>
                    ...
                    <Typography gutterBottom variant="h4" component="div">
                      {memberInfo.userConsulted ? removeHyphens(memberInfo.defaultService) : service.node.name}
                    </Typography>
                    <Typography gutterBottom variant="h6" component="div">
                      Duration: {memberInfo.userConsulted ? `${memberInfo.durationService/60} hrs`: viewModel.duration} {/* {service.node.durationMinutes / 60} hour */}
                    </Typography>
                    <Typography gutterBottom variant="h6" component="div">
                      {service.node.consultationOnly ? (
                        ...
                        `Price: ${memberInfo.userConsulted ? `£${memberInfo.costServicePence/100}` : viewModel.price}` /* `Price: £${service.node.pricePence / 100}` */
                      )}
                    </Typography>
                  </CardContent>
