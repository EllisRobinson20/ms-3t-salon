        ...
        <Grid container spacing={8} justifyContent="center">
          ...
          <Grid item xs={12} sm={10} md={8} lg={6}>
            <img
              ...
              src={headerImage}
              alt="Latoya, founder and hair stylist at the salon"
            />
          </Grid>
          <Grid
            item
          ...
          >
            ...
            <Link to="#" className={styles.button} onClick={handleOpen}>
              Gallery
            </Link>
          </Grid>
        </Grid>
...
export const query = graphql`
  query AboutPageImageQuery {
    header: allCloudinaryMedia(
      sort: { fields: created_at, order: DESC }
      filter: { secure_url: { regex: "/stylists/demo/" } }
    ) {
      edges {
        node {
          id
    ...
    gallery: allCloudinaryMedia(
      sort: { fields: created_at, order: DESC }
      filter: { secure_url: { regex: "/clients/" } }
    ) {
      edges {
        node {
          id
